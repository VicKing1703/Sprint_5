...
class Locators:
    ...
    # Локаторы для логина
    INPUT_EMAIL = (By.XPATH, "//fieldset[1]/div/div/input")  # поле "Email" на экране логина
    ...
    INPUT_EMAIL_REG = (By.XPATH, "//fieldset[2]/div/div/input")  # поле "Email" на экране регистрации
